...
struct integer_sequence_impl {
    static_assert(MPL_L::is_integral_v<_Ty>,
...
struct __make_integer_sequence_check
{
  ...
  * For error examples provided by Eric Fusellier, see
  *   https://stackoverflow.com/questions/20441293/static-assert-does-not-break-compiling-immediately
  */
