...
{
    constexpr unsigned long hash_prime_list_num = 32;
...
protected:
    ...
    {
        destroy_at(::std::addressof(node->value));
        __node_allocator.deallocate(node);
    }
