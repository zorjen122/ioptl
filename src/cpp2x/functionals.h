...
#define UNARY_ARITHMETIC_FUNC_OP(NAME,IS_A_OBJ,RETURN,OP)                   \
    template<class _Ty>                                                     \
    struct NAME : public IS_A_OBJ<_Ty,  RETURN> {                           \
...
namespace iop {
    ...
    private:
        ...
        private:
            ...
            explicit comom_func(_F&& __f) : f(FViop::forward<_F>(__f)) {}
            ...
            virtual _R invoke(_Args&&... __args) const NOEXCEPT {
                return f(FViop::forward<_Args>(__args)...);
            }
    ...
    public:
        ...
        template<class _F>
        function(_F&& __f)
            : func__(new comom_func<_F>(FViop::forward<_F>(__f))) {}
        ...
        IOP_CONSTEXPR_CXX17 _R operator()(_Args&&... __args) const {
            if (static_cast<bool>(*this) == false)
                ...
                return func__->invoke(FViop::forward<_Args>(__args)...);
        }
...
//* The following is removed in c++20 and deprecated in c++17. See cppreference.
    ...
    public:
        ...
        IOP_CONSTEXPR_CXX17 _R operator()(_Ty&& __v) const NOEXCEPT {
            return f(FViop::forward<_Ty>(__v));
        }
    };
    ...
    public:
        ...
        IOP_CONSTEXPR_CXX17 _R operator()(_Ty&& __a, _Tp&& __b) const NOEXCEPT {
            return f(FViop::forward<_Ty>(__a), FViop::forward<_Tp>(__b));
        }
    };
