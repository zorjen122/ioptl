...
#ifndef _ALGORITHM_IOP_
#define _ALGORITHM_IOP_

#include "../meta/functionalF.h"
#include "../util/utilityF.h"
#include "../util/iterator_utilF.h"

/*
    该文件用于支持如封装指针类或迭代器类的基本算法操作.
    (This file is used to support basic algorithm 
        operations such as encapsulating 
            pointer classes or iterator classes.)
*/
namespace iop_algo {
