...
#ifndef __METAUTIL_MPL__
#define __METAUTIL_MPL__
...
namespace mpls {
    ...
    template <class T> struct _this_type { using type = T; };
    ...
    template <bool V, class _T, class _R> struct if_bool
    {
        using type = _T;
    };

    template <class _T, class _R> struct if_bool<false, _T, _R>
    {
        using type = _R;
    };

    template <class _Bool, class _T, class _R> struct if_
    {
        using type = typename if_bool<!!_Bool::value, _T, _R>::type;
    };

    template <bool V, class _Ty, class _Tp>
    using conditioni = if_bool<V, _Ty, _Tp>;
    
    template <bool V, class _Ty, class _Tp>
    using conditioni_t = typename if_bool<V, _Ty, _Tp>::type;
