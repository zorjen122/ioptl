#ifndef _IOP_MULTIMAP_DEF
#define _IOP_MULTIMAP_DEF
...
namespace iop {
    ...
    class multimap
    {
      ...
      public:
        multimap() : c() {}
        multimap(iterator __first, iterator __last) : c(__first, __last) {}
        multimap(const ::std::initializer_list<value_type> &__rhs) : c(__rhs) {}
        multimap(multimap &__rhs) : c(__rhs.begin(), __rhs.end()) {}

      protected:
        class value_compare
            : public binary_function<value_type, value_type, bool>
        {
            friend class multimap<_Key, _Tv, _Compare, _Alloc>;
      ...
      public:
        iterator insert(const value_type &__v) { return c.insert_equal(__v); }
